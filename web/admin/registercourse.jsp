    ...
    <div id="section-container">
        <section class="image-section" id="register">
            <div class="form-box-content">
                ...
                <small>Use link at bottom for Tutor ID reference. (Opens in new window)</small>
                <form action="courseregister" method="POST">  
                    ...
                    <label>
                        <small><a href="JavaScript:newPopup('tutormanagement?isList=true');">View all Tutors</a></small>
