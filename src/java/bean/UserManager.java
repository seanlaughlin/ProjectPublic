 ...
 * @author jackb
 */
//Used to control all CRUD operations relating to user objects and DB tables (Admin, Tutor, Student)
public class UserManager {
    ...
    //STUDENT METHODS
    //Register a new Student in the DB
    ...
    //Authenticate Student by checking email and password against info in db. Uses PassHash to compare hashed password from DB to plaintext
    ...
    //Update attribute in Students DB table and return updated Student object
    ...
    //Loads all Students in DB into Student ArrayList
    ...
    //Update attribute of Tutor in DB
    ...
    //Load all Tutors in DB into Tutor ArrayList
    ...
    //ADMIN METHODS
    //Authenticate Admin by checking email and password against info in db. Uses PassHash to compare hashed password from DB to plaintext
    ...
    //Update attribute of Admin in DB and return updated Admin object
    ...
    //DELETE USER
    //Delete user from their DB table (any type)
