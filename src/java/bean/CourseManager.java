...
public class CourseManager {
    ...
    //Adds Course to DB and returns int with Course ID
    ...
    //Deletes Course from DB and returns boolean to indicate delete success
    ...
    //Updates attribute of Course in DB and returns boolean to indicate update success
    public boolean updateCourseAttribute(String parameterName, String parameter, int courseId) throws SQLException, ClassNotFoundException {
        ...
        //Updates row that matches parameters. executeUpdate will return int equal to number of affected rows
    ...
    //Loads Course from DB and returjns Course object populated with attributes
    ...
    public ArrayList<Course> loadAllCourses() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                //Adds the Course object to the array list
    ...
    //Loads all Courses that are starting later than todays date
    public ArrayList<Course> loadFutureCourses() throws SQLException, ClassNotFoundException {
        ...
        while (rs.next()) {
            ...
            //Get todays date for date comparison
    ...
    //Loads all Students registered on a Course
    public ArrayList<Student> loadCourseStudents(int courseId) {
        ...
        try {
            ...
            //Selects all entries from Enrolments with matching Course ID and joins Student details from Students table
            ...
            while (rs.next()) {
                ...
                //Loads Student's Courses to populate Student object
    ...
    //Loads all Lessons for a Course
    ...
    //Loads Tutor assigned to a Course
    public Tutor loadCourseTutor(int courseId) {
        ...
        try {
            ...
            //Selects all entries in the Tutors table of the database that have a Tutor ID that matches the Course ID put into method
            ...
            while (rs.next()) {
                ...
                //Create new Tutor object with info from DB
    ...
    //Adds Lesson to Course by CourseID
    ...
    //Adds Lessons into Lessons table
    ...
    //Updates Students Lesson status in Enrollments table
    ...
    //Creates new entry in Enrollments table to record Student enrolled in Course
    ...
    //Deletes entry in Enrollments table by Student ID and Course ID
    ...
    //Loads all Courses for a Student by Student ID
    ...
    //Loads all Courses for a Tutor by Tutor ID
